//import 'package:expense_tracker_app/currency.dart';
    ...
    return Scaffold(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Text("All Expense",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
      ...
      floatingActionButton:  FloatingActionButton(
          ...
          onPressed: () {
            ...
            //   context,
            //   MaterialPageRoute(
            //       builder: (context) => ExpenseCurrency()
            //   ),
            //
            // );
          }
...
class Recents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      Container(
        padding: EdgeInsets.only(top: 0,bottom: 0,left: 10,right: 20),
        height: 100,
        width: 400,
        decoration: BoxDecoration(
          color: Color(0xFFFFFFFF),
